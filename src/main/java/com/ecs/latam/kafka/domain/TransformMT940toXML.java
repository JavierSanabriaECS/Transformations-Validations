...
public class TransformMT940toXML {
    ...
    public String separadorMT940 (String msg) throws DatatypeConfigurationException, ParseException {
        String mensaje =null;
        if(msg.contains("$")){
    ...
    public String transformacionPaginas(ArrayList<String> msg) throws DatatypeConfigurationException, ParseException {
        ArrayList<String> xmlListsOrgn = msg;
            ...
            BigDecimal valorTottwo = new BigDecimal("0");
    ...
    public String transformacionUnoaUno(ArrayList<String> msg) throws DatatypeConfigurationException, ParseException {
        ArrayList<String> xmlListsOrgn = msg;
      ...
      for(String transBig : xmlListsOrgn){
          ...
          if(f62F.getAmount().equals("0")||f62F.getAmount().equals(null)) {
              cb8two.setCdtDbtInd(CreditDebitCode.CRDT);
