...
public class TransformMCtoXML {
    ...
    public String transformacionMC(String cabecero, String detalles) throws DatatypeConfigurationException, ParseException {
        String result=null;
    ...
    public static String getdateFormatted(String date, String srcFormat, String destFormat) {
        String dest = null;
        try {
